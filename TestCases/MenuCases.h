...
#include "../Bocchi/BocchiApplication/MainMenuCase.h"
...
SUBMENU(MenuCase2, "2) Something more difficult", MainMenuCase);
    ...
    PAYLOADSUBMENU(MenuCase2_2, "2) Calculate difficult math expression", MenuCase2);

COMPONENT(MenuCase3);
PAYLOADSUBMENU(MenuCase3, "3) Run my COOL PIRATE SHIP game", MainMenuCase);
